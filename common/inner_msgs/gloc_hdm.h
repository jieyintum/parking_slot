...
namespace Fusion
{
    ...
    {
    public:
        FusionResult() : imutmsputc{0}, hdmap_state{Hdm::HDMapState::khdmap_nolink}, init_heading{0.0}, fusion_heading{0.0},
                         hd_ego_left{0, 0, 0}, hd_ego_right{0, 0, 0}, me_ego_left{0, 0, 0}, me_ego_right{0, 0, 0},
                         fusion_PosLL{
                             0,
                             0,
                         },
                         delta_p{0, 0}, init_PosLL{0, 0}
        {
    ...
    public:
        ...
        EHPNoCamPosition(const NoCam_Pos &msg) : system_time{msg.NoCam_SysTime}, relapos_linkid{msg.NoCam_LinkID},
