...
struct UssSlot : SingleSlot {
    ...
    {
        if( ( Fusion::isZero(msgPtr->float_left_slot_location_bx)
           && Fusion::isZero(msgPtr->float_left_slot_location_by) )
         || ( Fusion::isZero(msgPtr->float_left_slot_depth_px)
           && Fusion::isZero(msgPtr->float_left_slot_depth_py) )
         || ( Fusion::isZero(msgPtr->float_left_slot_depth_qx)
           && Fusion::isZero(msgPtr->float_left_slot_depth_qy) )
         || ( Fusion::isZero(msgPtr->float_left_slot_location_cx)
           && Fusion::isZero(msgPtr->float_left_slot_location_cy) )
        )
        {
    ...
    {
        if( ( Fusion::isZero(msgPtr->float_right_slot_location_bx)
           && Fusion::isZero(msgPtr->float_right_slot_location_by) )
         || ( Fusion::isZero(msgPtr->float_right_slot_depth_px)
           && Fusion::isZero(msgPtr->float_right_slot_depth_py) )
         || ( Fusion::isZero(msgPtr->float_right_slot_depth_qx)
           && Fusion::isZero(msgPtr->float_right_slot_depth_qy) )
         || ( Fusion::isZero(msgPtr->float_right_slot_location_cx)
           && Fusion::isZero(msgPtr->float_right_slot_location_cy) )
        )
        {
            isSlotInfoValid = false;
        }
