...
namespace Fusion
{
    namespace PSE
    {
        ...
        public:
            StaticElement(const std::vector<VertexStruct> &vertices, const uint8_t classification) : vertices_list(vertices), number_of_vertices(vertices.size()), classification(static_cast<Classification>(classification)) {};

            StaticElement(const int &id, const std::vector<VertexStruct> &vertices, const uint8_t classification) : id(id), vertices_list(vertices), number_of_vertices(vertices.size()), classification(static_cast<Classification>(classification)) {};
