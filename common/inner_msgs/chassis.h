...
namespace Fusion
{
    ...
    {
        Chassis() = default;
        Chassis(const loc_msgs::msg::ODOM::SharedPtr &msgPtr) : timestamp(msgPtr->header.stamp),
        ...
        Chassis(const vehicle_msgs::msg::ApIbs20msPdu05::SharedPtr &msgPtr) : timestamp(static_cast<uint64_t>(msgPtr->timestamp) * 1000000ULL),
