...
namespace Fusion
{
    namespace PSE
    {
        ...
        struct FusionSlot
        {
            ...
            {
                enum class Type
                { // 0:Default, without block, 1:predictive block, 2:detective block
                    NO_BLOCK = 0,
                    PREDICT,
                    DETECTIVE
                };
        ...
        public:
                ...
                const Odometry &odom)
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    corners[i].weightForBaseCorner =
                        ((TrackSlotType == Type::HORIZONTAL) && ((std::fabs(corners[i].baseCorner[0] - 1.0f) > 6) || (std::fabs(corners[i].baseCorner[1]) > 6))) ? 100 : corners[i].weightForBaseCorner;
                }
                ...
                if (TrackSlotType != Type::HORIZONTAL)
                {
                    ...
                    for (int i = 0; i < 2; i++)
                    {
                        ...
                        else if ((corners[i].weightForBaseCorner < maxBasePointUpdateCost) && (corners[i].weightForBaseCorner > minBasePointUpdateCost))
                        {
                        ...
                        if (((moveToP1 == true) && (egoLines_[0]->getIsUnitVectorInversed() == false)) || ((moveToP1 == false) && (egoLines_[0]->getIsUnitVectorInversed() == true)))
                        {
                        ...
                        if (((moveToP3 == true) && (egoLines_[2]->getIsUnitVectorInversed() == false)) || ((moveToP3 == false) && (egoLines_[2]->getIsUnitVectorInversed() == true)))
                        {
            ...
            {
                if ((isParkable == false) && (sensor != ContributingSensor::PURE_USS))
                {
                    ...
                    if ((isMovingDistanceAfterInit == false) && (initOdom.translation - odom.translation).norm() > 1.3)
                    {
                        isMovingDistanceAfterInit = true;
                    }

                    if ((isMovingDistanceAfterInit == true) &&
                        (((isEverBeforeFrontAxel == true) && (isEverAfterFrontAxel == true)) || ((isEverBeforeRearAxel == true) && (isEverAfterRearAxel == true)) || ((isEverAfterFrontAxel == true) && (isEverBeforeRearAxel == true))))
                    {
                        isParkable = true;
                    }
                }
