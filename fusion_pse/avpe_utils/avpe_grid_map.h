...
namespace Fusion
{
    ...
    public:
        ...
        AvpeGridMap(const float minX, const float minY, const float deltaX, const float deltaY, const float precision) : GridMap<AvpeGrid>(minX, minY, deltaX, deltaY, precision)
        {
    ...
    public:
        ...
        AvpeGridMapImg(const float minX, const float minY, const float deltaX, const float deltaY, const float precision) : AvpeGridMap(minX, minY, deltaX, deltaY, precision)
        {
